...
% Physical Constants CODATA 2014 for Conventional Electrical Units 90
    ...
    properties (Constant)
        ...
        Kj =        DistProp.Const2014.data.Kj;          % Conventional value of Josephson constant / (Hz/V)
        Rk =        DistProp.Const2014.data.Rk;          % Conventional value of von Klitzing constant / Ohm
