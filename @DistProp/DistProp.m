...
%
% The values of a can be accessed through a<a href="matlab:help DistProp.Value -displayBanner">.Value</a> or <a href="matlab:help DistProp.get_value -displayBanner">get_value</a>(a), 
% and the standard uncertainties through a<a href="matlab:help DistProp.StdUnc -displayBanner">.StdUnc</a> or <a href="matlab:help DistProp.get_stdunc -displayBanner">get_stdunc</a>(a).
...
%   <a href="matlab:help DistProp.get_idof -displayBanner"               >get_idof</a>                Inverse degrees of freedeom
...
% Metas.UncLib.Matlab.DistProp V2.6.0
...
% x and xx are ignored. While y has to be a DistProp, x and xx can be any
...
% uncertainties of x and xx are ignored. While y has to be a DistProp, x and
...
% are ignored. While y has to be a DistProp, x and xx can be any type.
%
...
% interpolation of y. See <a href="matlab:s=which('DistProp');[s,~,~]=fileparts(s);edit([s,'\..\Examples\Example_Interpolation.m']);">Examples/Example_Interpolation.m</a>
%
...
% tainties of x are ignored. While y has to be a DistProp, x can be any
...
% uncertainties of x are ignored. While y has to be a DistProp, x can be any
% type. The parameter n must be a positive integer smaller than numel(y).
%
...
% DistProp vector of the same size as y which contains the cummlative
...
% has to be a DistProp, x can be any type.
%
