% Metas.UncLib.Matlab.MCProp V2.7.1
...
classdef MCProp < matlab.mixin.CustomDisplay
    ...
    methods
            ...
            switch nargin
                ...
                case 2
                    ...
                    elseif isa(varargin{1}, 'Metas.UncLib.Core.Unc.Distribution') && isa(varargin{2}, 'char')
                        obj.NetObject = Metas.UncLib.MCProp.UncNumber(varargin{1}, UncInputId(), sprintf(varargin{2}));
                    else
                        error('Wrong type of input arguments')
                    end
                case 3
                    ...
                    elseif isa(varargin{1}, 'Metas.UncLib.Core.Unc.Distribution') && isa(varargin{2}, 'Metas.UncLib.Core.Unc.InputId') && isa(varargin{3}, 'char')
                        obj.NetObject = Metas.UncLib.MCProp.UncNumber(varargin{1}, varargin{2}, sprintf(varargin{3}));
                    else
                        error('Wrong type of input arguments')
                    end
                case 4
        ...
        function str = string(obj, varargin)
            % STRING Return MCProp matrix as string array.
            %
            ...
            if parser.Results.AlignColumns
                val_real_str = MCProp.alignColumn(val_real_str);
                unc_real_str = MCProp.alignColumn(unc_real_str);
            end
            ...
            if ~obj.IsComplex
                ...
                if parser.Results.AlignColumns
                    val_imag_str = MCProp.alignColumn(val_imag_str);
                    unc_imag_str = MCProp.alignColumn(unc_imag_str);
                end
    ...
    methods (Hidden, Access = protected)
        ...
        displayFooter(obj, inputname, varargin) % This function is different for MCProp
