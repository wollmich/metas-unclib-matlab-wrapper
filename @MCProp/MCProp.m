...
classdef MCProp < matlab.mixin.CustomDisplay
    ...
    methods(Hidden, Access = protected)
        function displayScalarObject(obj)
            ...
            fprintf('    %s\n\n', ...
                MCProp.toUncCharColumn(get_value(obj), get_stdunc(obj), obj.IsComplex));
        ...
        function displayNonScalarObject(obj)
            ...
            if ismatrix(value)
                MCProp.printPage(value, stdunc, obj.IsComplex);
            else
                ...
                for ii = 1:prod(sizeRes)
                    ...
                    MCProp.printPage(value(:, :, pageSubs{:}), stdunc(:, :, pageSubs{:}), obj.IsComplex);
                end
            end
    ...
    methods(Static, Access = private)
        function printPage(value, stdunc, isComplex)
            ...
            for ii = 1:nColumns
                columns{ii} = [repmat(' ', spacing, nRows); MCProp.toUncCharColumn(value(:, ii), stdunc(:, ii), isComplex)];
            end
        ...
        function column = toUncCharColumn(value, stdunc, isComplex)
            % Used to format a scalar or vector of MCProps as a char
            ...
            if isComplex
                columnReal = MCProp.toUncPartCharColumn(real(value), real(stdunc), 1, false);
                columnImag = MCProp.toUncPartCharColumn(imag(value), imag(stdunc), 3, true);
                ...
                column = MCProp.toUncPartCharColumn(value, stdunc, 1, false);
            end
        ...
        function column = toUncPartCharColumn(value, stdunc, signSpacing, showPlus)
            ...
            %
            % Used to format a vector of non-complex MCProps as a char
            % matrix with (value +/- stdunc) notation.
            %
            % Inputs:
            %   value           vector of nominal values to format
            ...
            column = [...
                signs; ...
                repmat(('(')', 1, n); ...
                MCProp.toCharColumn(abs(value)); ...
                repmat(pm', 1, n); ...
                MCProp.toCharColumn(stdunc); ...
                repmat((')')', 1, n); ...
            ];
